...
#ifndef lint
static const char rcsid[] = "$Id: snprintf.c,v 1.4 2003/03/04 09:16:27 wcc Exp $";
#endif
...
#if defined(HAVE_SNPRINTF) && defined(HAVE_VSNPRINTF) && defined(HAVE_C99_VSNPRINTF) || defined(DONT_USE_SNPRINTFS)
